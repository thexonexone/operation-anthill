# ============================================================
#  ANTHILL CORE v1.4.2 - Single File Python Version
#  Requirements: pip install pydantic rich requests fastapi uvicorn
#  Optional local AI: ollama pull llama3.1:8b
#
#  v1.4.2 focus:
#  - API Runtime + Event Safety
#  - Background API mission jobs so /health and read endpoints stay responsive
#  - Safe system mission for API events instead of fake mission_id="api"
#  - API job registry, mission detail endpoint, and approvals formatting cleanup
#  - Preserves v1.4.1 API safety and v1.3.2 research cleanup
# ============================================================
...
def run_api_server():
    ...
    if uvicorn is None:
        ...
        return
    app = create_api_app()
    print(f"[bold yellow]ANTHILL Core v1.4.2 API online at http://{API_HOST}:{API_PORT}[/bold yellow]")
