...
namespace Anthill.Modules.Homelab.Health;
...
public sealed class HealthCheckRunner
{
    ...
    private static TimeSpan TimeoutFor(HealthCheckSchedule s) =>
        TimeSpan.FromMilliseconds(s.TimeoutMs > 0 ? Math.Clamp(s.TimeoutMs, 250, 60_000) : HomelabRuntime.Options.HealthTimeoutMs);
