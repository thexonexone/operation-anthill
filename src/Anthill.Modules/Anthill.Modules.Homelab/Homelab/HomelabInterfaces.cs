...
public interface IHomelabRepository : IHomelabEventSink
{
    ...
    void UpsertHealthSchedule(Anthill.Modules.Homelab.Health.HealthCheckSchedule schedule, string changedBy);
    void RemoveHealthSchedule(string id, string removedBy);
    IReadOnlyList<Anthill.Modules.Homelab.Health.HealthCheckSchedule> ListHealthSchedules();
