...
namespace Anthill.Modules.Homelab.Security;
...
public sealed class HomelabCredentialStore : ICredentialProvider
{
    ...
    public HomelabCredentialStore(HomelabRepository repository, IFieldCipher? cipher = null)
    {
        _repository = repository;
        // v3.8.7: null is a supported state. The colony runs unencrypted by default, and a
        // homelab that refused to start without a cipher would be stricter than the core.
        _cipher = cipher ?? HomelabRuntime.Cipher;
    }
